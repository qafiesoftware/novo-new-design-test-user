...
import darkmode from "../../public/images/logo/darkmode.png";
import lightmode from "../../public/images/logo/lightmode.png";
import PartnerButton from "@/components/common/PartnerButton";

interface AppSidebarProps {
  isIB: number | string;
}

const AppHeader: React.FC<AppSidebarProps> = ({ isIB }) => {
  ...
  return (
    <header className="sticky top-0 z-[100] flex w-full border-gray-200 bg-white lg:border-b dark:border-gray-800 dark:bg-gray-900">
      <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div className="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4 dark:border-gray-800">
          ...
          <Link href="/" className="lg:hidden">
            <Image width={154} height={32} className="dark:hidden" src={darkmode} alt="Logo" />
            <Image
              width={154}
              height={32}
          ...
          <button
            ...
            aria-label={isMobileOpen ? "Close application menu" : "Open application menu"}
