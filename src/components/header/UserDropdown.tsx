    ...
    <div className="relative">
      ...
      >
        <div>
          ...
          <span className="text-theme-sm mt-0.5 block text-gray-500 dark:text-gray-400">
            {user?.user_reg_code}
          </span>
        </div>
        ...
        <ul className="flex flex-col gap-1 border-b border-gray-200 pt-4 pb-3 dark:border-gray-800">
          ...
          <hr />
          {/* MAIN MENU TITLE: Tool & Services */}
          <li className="relative">
            <button
              onClick={() => setToolsOpen(!toolsOpen)}
              className="text-theme-sm flex w-full items-center justify-between rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
            >
              <span className="flex items-center gap-3">
                <PiScrewdriver size={24} />
                Tool & Services
              </span>
            ...
            {/* SUBMENU */}
            {toolsOpen && (
              <ul className="mt-1 ml-4 space-y-1 border-l border-gray-200 pl-2 dark:border-white/10">
                <li>
                  <DropdownItem
                    onItemClick={closeDropdown}
                    tag="a"
